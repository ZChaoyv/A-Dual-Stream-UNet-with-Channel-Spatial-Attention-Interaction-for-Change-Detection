...
################################################################################
#                                                                              
#              🛠️ UTILS & HELPER FUNCTIONS FOR CD PIPELINE                      
#                  🛠️ 变化检测流水线工具函数与辅助类
#                        👤 AUTHOR: Caoyv                                        
#                      📄 PAPER: DCSI_UNet 
#           https://ieeexplore.ieee.org/document/11299285                                 
#                                                                              
#   Description: This script provides essential utility functions including     
#   data loading, tensor visualization, device management, and metric tracking. 
#   代码说明：本程序提供核心工具功能，包括数据加载、张量可视化、设备管理及指标追踪。       
#                                                                              
################################################################################
